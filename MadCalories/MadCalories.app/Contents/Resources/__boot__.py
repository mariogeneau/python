...
_recipes_pil_prescript(['WmfImagePlugin', 'GifImagePlugin', 'XpmImagePlugin', 'TiffImagePlugin', 'PdfImagePlugin', 'PcxImagePlugin', 'SunImagePlugin', 'PpmImagePlugin', 'CurImagePlugin', 'XVThumbImagePlugin', 'IcoImagePlugin', 'PngImagePlugin', 'BlpImagePlugin', 'ImtImagePlugin', 'DcxImagePlugin', 'SpiderImagePlugin', 'IcnsImagePlugin', 'FtexImagePlugin', 'MspImagePlugin', 'WebPImagePlugin', 'GribStubImagePlugin', 'FliImagePlugin', 'ImImagePlugin', 'EpsImagePlugin', 'MpegImagePlugin', 'JpegImagePlugin', 'FpxImagePlugin', 'PalmImagePlugin', 'BmpImagePlugin', 'PixarImagePlugin', 'SgiImagePlugin', 'MicImagePlugin', 'Hdf5StubImagePlugin', 'FitsStubImagePlugin', 'BufrStubImagePlugin', 'McIdasImagePlugin', 'DdsImagePlugin', 'IptcImagePlugin', 'MpoImagePlugin', 'PsdImagePlugin', 'XbmImagePlugin', 'PcdImagePlugin', 'TgaImagePlugin', 'Jpeg2KImagePlugin', 'GbrImagePlugin'])
