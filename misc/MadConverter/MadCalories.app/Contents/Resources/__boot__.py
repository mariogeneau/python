...
_recipes_pil_prescript(['WebPImagePlugin', 'PsdImagePlugin', 'BmpImagePlugin', 'Jpeg2KImagePlugin', 'ImImagePlugin', 'MpegImagePlugin', 'PixarImagePlugin', 'MicImagePlugin', 'FpxImagePlugin', 'CurImagePlugin', 'McIdasImagePlugin', 'SpiderImagePlugin', 'GifImagePlugin', 'GbrImagePlugin', 'XpmImagePlugin', 'XVThumbImagePlugin', 'IcnsImagePlugin', 'TgaImagePlugin', 'IptcImagePlugin', 'SgiImagePlugin', 'WmfImagePlugin', 'BufrStubImagePlugin', 'SunImagePlugin', 'GribStubImagePlugin', 'IcoImagePlugin', 'PpmImagePlugin', 'BlpImagePlugin', 'ImtImagePlugin', 'EpsImagePlugin', 'PdfImagePlugin', 'FliImagePlugin', 'TiffImagePlugin', 'XbmImagePlugin', 'FtexImagePlugin', 'DdsImagePlugin', 'PcdImagePlugin', 'MspImagePlugin', 'PngImagePlugin', 'DcxImagePlugin', 'PcxImagePlugin', 'PalmImagePlugin', 'MpoImagePlugin', 'JpegImagePlugin', 'Hdf5StubImagePlugin', 'FitsStubImagePlugin'])
